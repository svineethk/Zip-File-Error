...
dependencies:
  ...
  react-icons: 4.3.1_react@17.0.1
...
packages:
  ...
  /@babel/helper-module-imports/7.24.7_supports-color@5.5.0:
    ...
    engines: {node: '>=6.9.0'}
    dependencies:
      '@babel/traverse': 7.25.6_supports-color@5.5.0
      '@babel/types': 7.25.6
    transitivePeerDependencies:
      - supports-color
    dev: false
  ...
  /babel-plugin-styled-components/1.13.2_63c084c908af754ba5727246e89687ea:
  ...
  /debug/4.3.7_supports-color@6.1.0:
    resolution: {integrity: sha512-Er2nc/H7RrMXZBFCEim6TCmMk02Z8vLC2Rbi1KEBggpo0fS6l0S1nnapwmIi3yW/+GOJap1Krg4w0Hg80oCqgQ==}
    engines: {node: '>=6.0'}
    peerDependencies:
      supports-color: '*'
